        ...
        <div className="Footer">
            <div className="Footer-div">
                ...
                <div className="Footer-Links">
                    <h3>Useful Links</h3>
                    <li className="Footer-NavList"><Link className="Footer-NavLinks Footer-NavLinks-1 " to="/Dashboard">Dashboard</Link></li>
                    <li className="Footer-NavList"><Link className="Footer-NavLinks Footer-NavLinks-1 " to="/MyCars">My Cars</Link></li>
                    <li className="Footer-NavList"><Link className="Footer-NavLinks Footer-NavLinks-1 " to="/AddCar">Add my Car</Link></li>
                   ...
                   <li className="Footer-NavList"><Link className="Footer-NavLinks Footer-NavLinks-1 " to="/ShowMap">Service Centers</Link></li>
                </div>
