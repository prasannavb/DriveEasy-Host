...
const ForgotPassword=(props)=>
{
    ...
    {
        await sendPasswordResetEmail(auth,Email,{url:'http://localhost:5173/'}).then(()=>{
        openNotification()
        setTimeout(() => {
          ...
          <ConfigProvider 
            ...
            <div className="ForgotPassword">
                ...
                <div className='ForgotPassword-btns'>
                    ...
                    <Link className='ForgotPassword-Linkbtn' to="/" onClick={()=>{SetPasswordReset(false)}} >Back To Login</Link>
                </div>
            </div>
        </div>
    )
