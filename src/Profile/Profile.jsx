...
const Profile=()=>
{
    ...
    {
        const {data}=await axios.post('https://drive-easy-host-server.vercel.app/findUserProfile',{sid})
    ...
    {
        const {data}=await axios.post('https://drive-easy-host-server.vercel.app/UpdateProfileDetails',ProfileDetails)
        const imageRef=ref(storage,`/images/${user.sid}`)
  ...
  {contextHolder}
            ...
            <div className="Profile-LeftNav">
                <Link to='/Dashboard' className='Profile-Backbtn'><LeftCircleFilled/></Link>
